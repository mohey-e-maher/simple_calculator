...
class Calculator:
    # all body aspects and features
    def __init__(self,master):
        # the title of the bofy of the program
        master.title("Mega_Calculator")
        # the height and width of the application 
        # geometry(' width x height + the x axis on the screen + the y axis on the screen ') function
        master.geometry('357x420+50+50')
